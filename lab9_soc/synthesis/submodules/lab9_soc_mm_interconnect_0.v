...
// 
// Generated using ACDS version 14.0 200 at 2015.04.01.00:18:16
...
module lab9_soc_mm_interconnect_0 (
	...
	wire   [12:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> nios2_qsys_0_instruction_master_agent:rp_channel
	...
	wire   [12:0] rsp_mux_001_src_channel;                                                            // rsp_mux_001:src_channel -> nios2_qsys_0_data_master_agent:rp_channel
	...
	wire   [12:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> nios2_qsys_0_jtag_debug_module_agent:cp_channel
	...
	wire   [12:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire   [12:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> sdram_s1_agent:cp_channel
	...
	wire   [12:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> key_2_s1_agent:cp_channel
	...
	wire   [12:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> key_3_s1_agent:cp_channel
	...
	wire          cmd_mux_009_src_endofpacket;                                                        // cmd_mux_009:src_endofpacket -> jtag_uart_0_avalon_jtag_slave_agent:cp_endofpacket
	wire          cmd_mux_009_src_valid;                                                              // cmd_mux_009:src_valid -> jtag_uart_0_avalon_jtag_slave_agent:cp_valid
	wire          cmd_mux_009_src_startofpacket;                                                      // cmd_mux_009:src_startofpacket -> jtag_uart_0_avalon_jtag_slave_agent:cp_startofpacket
	wire  [106:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> jtag_uart_0_avalon_jtag_slave_agent:cp_data
	wire   [12:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> jtag_uart_0_avalon_jtag_slave_agent:cp_channel
	wire          cmd_mux_009_src_ready;                                                              // jtag_uart_0_avalon_jtag_slave_agent:cp_ready -> cmd_mux_009:src_ready
	...
	wire          cmd_mux_010_src_endofpacket;                                                        // cmd_mux_010:src_endofpacket -> to_hw_port_s1_agent:cp_endofpacket
	wire          cmd_mux_010_src_valid;                                                              // cmd_mux_010:src_valid -> to_hw_port_s1_agent:cp_valid
	wire          cmd_mux_010_src_startofpacket;                                                      // cmd_mux_010:src_startofpacket -> to_hw_port_s1_agent:cp_startofpacket
	wire  [106:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> to_hw_port_s1_agent:cp_data
	wire   [12:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> to_hw_port_s1_agent:cp_channel
	wire          cmd_mux_010_src_ready;                                                              // to_hw_port_s1_agent:cp_ready -> cmd_mux_010:src_ready
	...
	wire          cmd_mux_012_src_endofpacket;                                                        // cmd_mux_012:src_endofpacket -> to_sw_port_s1_agent:cp_endofpacket
	wire          cmd_mux_012_src_valid;                                                              // cmd_mux_012:src_valid -> to_sw_port_s1_agent:cp_valid
	wire          cmd_mux_012_src_startofpacket;                                                      // cmd_mux_012:src_startofpacket -> to_sw_port_s1_agent:cp_startofpacket
	wire  [106:0] cmd_mux_012_src_data;                                                               // cmd_mux_012:src_data -> to_sw_port_s1_agent:cp_data
	wire   [12:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> to_sw_port_s1_agent:cp_channel
	wire          cmd_mux_012_src_ready;                                                              // to_sw_port_s1_agent:cp_ready -> cmd_mux_012:src_ready
	...
	wire  [106:0] jtag_uart_0_avalon_jtag_slave_agent_rp_data;                                        // jtag_uart_0_avalon_jtag_slave_agent:rp_data -> router_011:sink_data
	...
	wire          to_hw_port_s1_agent_rp_endofpacket;                                                 // to_hw_port_s1_agent:rp_endofpacket -> router_012:sink_endofpacket
	wire          to_hw_port_s1_agent_rp_valid;                                                       // to_hw_port_s1_agent:rp_valid -> router_012:sink_valid
	wire          to_hw_port_s1_agent_rp_startofpacket;                                               // to_hw_port_s1_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire  [106:0] to_hw_port_s1_agent_rp_data;                                                        // to_hw_port_s1_agent:rp_data -> router_012:sink_data
	wire          to_hw_port_s1_agent_rp_ready;                                                       // router_012:sink_ready -> to_hw_port_s1_agent:rp_ready
	...
	wire          to_sw_port_s1_agent_rp_endofpacket;                                                 // to_sw_port_s1_agent:rp_endofpacket -> router_014:sink_endofpacket
	wire          to_sw_port_s1_agent_rp_valid;                                                       // to_sw_port_s1_agent:rp_valid -> router_014:sink_valid
	wire          to_sw_port_s1_agent_rp_startofpacket;                                               // to_sw_port_s1_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire  [106:0] to_sw_port_s1_agent_rp_data;                                                        // to_sw_port_s1_agent:rp_data -> router_014:sink_data
	wire          to_sw_port_s1_agent_rp_ready;                                                       // router_014:sink_ready -> to_sw_port_s1_agent:rp_ready
	...
	lab9_soc_mm_interconnect_0_router_007 router_013 (
	...
	lab9_soc_mm_interconnect_0_router_007 router_014 (
	...
	lab9_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_011 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab9_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_012 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab9_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_011 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab9_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_012 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
